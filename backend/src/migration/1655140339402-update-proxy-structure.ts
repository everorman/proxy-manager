...
export class updateProxyStructure1655140339402 implements MigrationInterface {
    name = 'updateProxyStructure1655140339402'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`proxy\` ADD \`owner\` varchar(255) NOT NULL`);
